...
EAS pozwala organizacjom na centralną kontrolę i zgłaszanie dostępu
do powłoki uniksowej. W przeciwieństwie do Sudosh logi audytowe są
wysyłane do scentralizowanego archiwum i na serwer zgłoszeniowy.
Uwierzytelnianie klient-serwer i szyfrowanie jest obsługiwane przez
SSL. EAS został zaprojektowany szczególnie do firmowego, komercyjnego
użytku.
